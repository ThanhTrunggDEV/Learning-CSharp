...
namespace Learning_CSharp.Struct_Exercises
{
    public struct Student5
    {
        ...
        public Student5(string Name, bool Gender, float mathScore, float physicsScore, float chemicalScore)
        {
            this.Name = Name;
            this.Gender = Gender;
    ...
    public struct Exercise5
    {
        public static List<Student5> ListStudents = new List<Student5>();
        public static void AddStudent()
        {
            ...
            for (int i = 0; i < n; i++)
            {
                ...
                ListStudents.Add(new Student5(Name, gender, mathScore, physicsScore, chemicalScore));
            }
        }
        public static void PrintStudents()
        {
            ...
            int stt = 1;
            foreach(Student5 student in ListStudents)
            {
